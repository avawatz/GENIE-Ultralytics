...
class Model(nn.Module):
    ...
    def predict(
        ...
        **kwargs,
        ...
        grad_emb = args.pop("grad_emb", False)
        ...
        return self.predictor.predict_cli(source=source) if is_cli else self.predictor(source=source, stream=stream, grad_emb=grad_emb)
